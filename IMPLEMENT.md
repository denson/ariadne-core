...
2. List the tools with brief descriptions:
...
Read the instructions block and verify it mentions the full tool set and doesn't say "25+" or reference the REST API for batch operations.
...
if missing:
    ...
    print(f'PASS: tools registered: {sorted(expected)}')
"
```
