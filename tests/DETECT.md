...
- The MCP server is running in Docker. Seven tools should be available: `convert_document`, `upload_and_convert`, `search`, `get_document`, `list_documents`, `list_collections`, `ingest`
