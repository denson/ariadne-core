...
- The MCP server is running in Docker. The following tools should be available: `convert_document`, `search`, `get_document`, `list_documents`, `list_collections`, `ingest`
